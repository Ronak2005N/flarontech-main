...
export const ScrollStackItem: React.FC<ScrollStackItemProps> = ({ children, itemClassName = '' }) => (
  <div
    className={`scroll-stack-card relative w-full h-auto min-h-[380px] md:min-h-[420px] my-6 md:my-8 p-5 md:p-8 lg:p-10 rounded-2xl md:rounded-3xl lg:rounded-[40px] shadow-[0_8px_24px_rgba(0,0,0,0.3)] box-border origin-top will-change-transform contain-layout ${itemClassName}`.trim()}
    style={{
...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  // Cleanup window listeners when useWindowScroll is true
    ...
    return (
      <div className={`relative w-full ${className}`.trim()}>
        <div className="scroll-stack-inner">
          {children}
          {/* Sentinel: pinEnd is calculated relative to this element */}
  ...
  return (
    ...
    >
      <div className="scroll-stack-inner pt-[10vh] px-0 pb-[40rem] min-h-screen">
        {children}
